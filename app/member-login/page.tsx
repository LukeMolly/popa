    ...
    <section className="member-login-stage">
      ...
      <section className="member-login-card">
        ...
        {!user ? <>
          ...
          <p>Use your membership email and 4-character alphanumeric password.</p>
          <MemberLoginClient/>
        ...
        <p className="member-login-note">Passwords are stored as one-way hashes. Five failed attempts temporarily lock the account.</p>
      </section>
    </section>
  </main>;
}
