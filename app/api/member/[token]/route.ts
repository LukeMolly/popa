...
export async function POST(request:Request,{params}:Context){
 try{
  ...
  try{
   await env.DB.prepare("INSERT INTO payments (id,member_id,amount,receipt_key,receipt_name,receipt_type,reference,status,note,created_at,reviewed_at,reviewed_by) VALUES (?,?,?,?,?,?,?,'submitted','Renewal payment',?,'','')")
